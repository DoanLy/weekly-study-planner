      ...
      {activeTab === 'notes' && (
        <div className="mx-auto max-w-7xl space-y-6">
          <section className="rounded-3xl border border-slate-100 bg-white p-5 shadow-sm md:p-6">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 rounded-2xl bg-indigo-600 px-5 py-3 text-sm font-bold text-white shadow-sm transition-all hover:bg-indigo-700"
              >
                <Plus size={18} />
                Thêm note
              </button>
            ...
            <div className="mt-5 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
              <div className="relative md:min-w-[360px]">
                ...
                <input
                  ...
                  className="w-full rounded-2xl border border-slate-200 bg-slate-50 py-3 pl-10 pr-4 text-sm font-semibold text-slate-700 outline-none transition-all focus:border-indigo-300 focus:bg-white focus:ring-2 focus:ring-indigo-100"
                />
              </div>
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                <span className="rounded-2xl bg-indigo-50 px-4 py-2 text-sm font-black text-indigo-700">
            ...
            <div className="mt-4 flex flex-wrap items-center gap-2 rounded-2xl bg-slate-50 p-2">
              <button
                ...
                className="rounded-xl bg-white px-3 py-2 text-sm font-black text-red-600 shadow-sm transition-all hover:bg-red-50"
              ...
              <button
                ...
                className="rounded-xl bg-yellow-100 px-3 py-2 text-sm font-black text-yellow-900 shadow-sm transition-all hover:bg-yellow-200"
              ...
              <button
                ...
                className="rounded-xl bg-white px-3 py-2 text-sm font-black text-slate-600 shadow-sm transition-all hover:bg-slate-100"
          ...
          <section className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
            <div className="hidden grid-cols-[1.05fr_0.95fr_1fr_150px] border-b border-slate-200 bg-slate-100 text-sm font-black text-slate-700 md:grid">
              <div className="border-r border-slate-200 p-4">Nội dung chính</div>
              <div className="border-r border-slate-200 p-4">
                Ghi chú / Giải thích
              </div>
              <div className="border-r border-slate-200 p-4">Bổ sung</div>
              <div className="p-4 text-center">Trạng thái</div>
            </div>
            ...
            {visibleNotes.length > 0 ? (
              <div className="divide-y divide-slate-200">
                {visibleNotes.map((note) => (
                  <div
                    key={note.id}
                    className="grid grid-cols-1 md:grid-cols-[1.05fr_0.95fr_1fr_150px]"
                  >
                    {[
                      {
                        field: 'main',
                      ...
                      <div
                        key={cell.field}
                        className="border-slate-200 p-3 md:border-r"
                      >
                        ...
                        <RichNoteCell
                          ...
                          className={`min-h-24 w-full resize-y rounded-xl border border-transparent bg-transparent p-2 text-[15px] leading-relaxed outline-none transition-all hover:bg-slate-50 focus:border-indigo-200 focus:bg-white focus:ring-2 focus:ring-indigo-100 ${cell.className}`}
                        />
                      </div>
                    ))}

                    <div className="flex items-center justify-between gap-3 bg-slate-50 p-3 md:flex-col md:justify-center md:bg-white">
                      <button
                        onClick={() =>
